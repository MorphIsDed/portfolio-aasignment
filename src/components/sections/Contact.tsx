            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm dark:text-gray-300 text-gray-700 group-hover:text-accent-400 transition-colors">
                    {personalInfo.email}
                  </span>
                </a>
          ...
          <ScrollReveal delay={0.15}>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium dark:text-gray-300 text-gray-700 mb-1.5">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium dark:text-gray-300 text-gray-700 mb-1.5">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium dark:text-gray-300 text-gray-700 mb-1.5">
                    Message
                  </label>
                  <textarea
                    id="message"
