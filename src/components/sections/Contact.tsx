            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm dark:text-gray-300 text-gray-900 group-hover:text-accent-500 dark:group-hover:text-accent-400 transition-colors">
                    {personalInfo.email}
                  </span>
                </a>
          ...
          <ScrollReveal delay={0.15}>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium dark:text-gray-300 text-gray-900 mb-1.5">
                    Name
                  </label>
                  <input
                    type="text"
                    id="name"
                    required
                    className="w-full rounded-xl border dark:border-dark-600 border-gray-200 dark:bg-dark-800 bg-gray-50 px-4 py-3 text-sm dark:text-gray-200 text-gray-900 placeholder:dark:text-gray-600 placeholder:text-gray-700 outline-none focus:border-accent-500 focus:ring-1 focus:ring-accent-500 transition-colors"
                    placeholder="Your name"
                  />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium dark:text-gray-300 text-gray-900 mb-1.5">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium dark:text-gray-300 text-gray-900 mb-1.5">
                    Message
                  </label>
                  <textarea
                    id="message"
