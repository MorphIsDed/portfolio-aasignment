      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="premium-shell flex flex-col items-start justify-between gap-5 px-6 py-6 sm:flex-row sm:items-center sm:px-8">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-500 sm:text-sm">
            &copy; {year} {personalInfo.name}. Crafted with React, motion, and care.
          </p>
          <div className="flex items-center gap-5">
            <a
              ...
              aria-label="GitHub"
              className="text-gray-500 transition-colors hover:text-accent-600 dark:text-gray-500 dark:hover:text-accent-400"
            >
